...
(typeof module === "undefined" ? "undefined" : _typeof_1(module)) === "object" ? module.exports : {});
...
function () {
  function RelaksEventEmitter() {
    classCallCheck(this, RelaksEventEmitter);
  ...
  createClass(RelaksEventEmitter, [{
    ...
    key: "dispatchEvent",
    value: function () {
      var _dispatchEvent = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee(evt, listeners) {
...
function () {
  ...
  createClass(GenericEvent, [{
    ...
    key: "waitForDecision",
    value: function () {
      var _waitForDecision = asyncToGenerator(
      /*#__PURE__*/
